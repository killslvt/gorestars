function enterPortal() {
    const audio = new Audio('POCKETS FAT DAVE BLUNTS.mp3');
    audio.volume = 0.5; //If Anyone Want A Black Background

    const typing = document.getElementById('typing');
    const cursor = document.getElementById('cursor');
    const texts = ["abuse me?", "/info", "gorestars", "Inclinarse ante la mano de Dios"];
    let textIndex = 0;
    let charIndex = 0;
